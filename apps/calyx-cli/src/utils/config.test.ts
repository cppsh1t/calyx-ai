...
describe("Configuration Management", () => {
  ...
  describe("Reading Configuration", () => {
    ...
    test("readConfig throws EXISTS error for missing file", async () => {
      ...
      await expect(readConfig(nonExistentPath)).rejects.toThrow(
        "does not exist",
      );
    ...
    test("readConfig throws PARSE_ERROR for invalid JSON", async () => {
      ...
      await expect(readConfig(testPath)).rejects.toThrow(
  ...
  describe("ConfigError Class", () => {
    ...
    test("ConfigError works with all error types", () => {
      ...
      const writeError = new ConfigError(
        ConfigErrorType.WRITE_ERROR,
        "Write failed",
      );
      const existsError = new ConfigError(
